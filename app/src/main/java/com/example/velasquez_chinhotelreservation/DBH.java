...
public class DBH extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "AddRooms.db";
    public static final String TABLE_NAME = "Admin_AddRoom";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,ROOMTYPE TEXT,BEDS INTERGER,AVAILABLE INTERGER)");
    }
