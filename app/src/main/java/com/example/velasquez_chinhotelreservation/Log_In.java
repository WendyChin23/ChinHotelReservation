    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkUser == true) {
                    Toast.makeText(Log_In.this, "Sign In Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent1 = new Intent(getApplicationContext(), Menu_Admin.class);
                    startActivity(intent1);
                } else
                    Toast.makeText(Log_In.this, "User Doesn't Exists", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
